  ...
  return (
    ...
    <section id="contact" className="py-16 md:py-20">
      ...
      >
        ...
        <p className="text-base md:text-lg text-gray-600 dark:text-gray-300 max-w-xl mx-auto mb-8">
          Saya selalu terbuka untuk diskusi mengenai proyek baru, peluang kreatif, atau sekadar untuk bertukar pikiran. Jangan ragu untuk mengirim saya email.
        </p>
        <a
